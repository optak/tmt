...
class Common(object):
    ...
    def run(self, command, message=None, cwd=None, dry=False, log=None):
        """
        ...
        try:
            return self._run(command, cwd=cwd or self.workdir, log=log or self.debug)
